...
if __name__ == "__main__":
    ...
    x = torch.randint(low=0, high=vocab_size, size=(args.batch_size, args.max_seq_len), dtype=torch.long, device=device)
    targets = torch.randint(low=0, high=vocab_size, size=(args.batch_size, args.max_seq_len), dtype=torch.long, device=device)
